...
{
    protected string $folder = 'content/partners';
    protected string $route = 'partnerss';
        ...
        if ($request->ajax()) {
            ...
            ->editColumn('image', function ($obj) {
                ...
                ->addColumn('action', function ($obj) {
                            ...
                            if ($user && $user->can( "partnerss_edit")) {
                                $buttons .= '
                            ...
                            if ($user && $user->can("partnerss_delete")) {
                                $buttons .= '
                                    <button type="button" 
    ...
    {
        if (isset($data['image'])) {
            $data['image'] = $this->handleFile($data['image'], 'Partners');
        }
