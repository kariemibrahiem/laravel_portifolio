...
@section('title', trns('Create Project'))
    ...
    <div class="card project-form-card">
        <div class="card-body p-4 p-lg-5">
            <form action="{{ route($route . '.store') }}" method="POST" enctype="multipart/form-data">
                ...
                @php
                    $selectedType = old('project_type', 'website');
                @endphp

                <div class="row g-4">
                    <div class="col-md-6">
                        <label class="form-label" for="title">{{ trns('title') }}</label>
                        <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" placeholder="Project name" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="category" name="category" value="{{ old('category') }}" placeholder="marketing, saas, ecommerce..." required>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="description" name="description" placeholder="Short project summary" required>{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <select class="form-select" id="collaborator_ids" name="collaborator_ids[]" multiple>
                            @foreach ($collaborations as $item)
                                <option value="{{ $item->id }}" {{ old('collaborator_ids') && in_array($item->id, old('collaborator_ids')) ? 'selected' : '' }}>
                                    {{ $item->name }}
                                </option>
                            @endforeach
                        </select>
                        <small class="text-muted-soft d-block mt-2">You can select more than one collaborator for the same project.</small>
                    </div>
                        ...
                        <div class="link-group">
                            <div class="row g-4">
                                <div class="col-12 col-lg-4" id="website-link-wrapper">
                                    ...
                                    <input type="url" class="form-control" id="website_url" name="website_url" value="{{ old('website_url', old('url')) }}" placeholder="https://example.com">
                                </div>
                                ...
                                <div class="col-12 col-lg-4 mobile-link-field" id="google-play-wrapper">
                                    ...
                                    <input type="url" class="form-control" id="google_play_url" name="google_play_url" value="{{ old('google_play_url') }}" placeholder="https://play.google.com/store/apps/details?id=...">
                                </div>
                                ...
                                <div class="col-12 col-lg-4 mobile-link-field" id="app-store-wrapper">
                                    ...
                                    <input type="url" class="form-control" id="app_store_url" name="app_store_url" value="{{ old('app_store_url') }}" placeholder="https://apps.apple.com/...">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-wrap gap-2 mt-4">
                    <button type="submit" class="btn btn-primary px-4">{{ trns('create') }}</button>
